...
import {
  ...
  CheckCircle, Clock, TrendingUp, Building2, Star
} from 'lucide-react';
...
export default function AdminPage() {
  ...
  const stats = [
    { label: 'کاربران', value: '۱۲۴', icon: <Users size={24} />, color: 'text-blue-600', bg: 'bg-blue-50', link: '/admin/users' },
    { label: 'محصولات', value: '۸۷', icon: <ShoppingBag size={24} />, color: 'text-purple-600', bg: 'bg-purple-50', link: '/admin/products' },
    { label: 'باشگاه‌ها', value: '۴۳', icon: <Building2 size={24} />, color: 'text-green-600', bg: 'bg-green-50', link: '/admin/clubs' },
    { label: 'مسابقات', value: '۱۲', icon: <Trophy size={24} />, color: 'text-amber-600', bg: 'bg-amber-50', link: '/admin/events' },
    { label: 'اخبار', value: '۳۶', icon: <Newspaper size={24} />, color: 'text-red-600', bg: 'bg-red-50', link: '/admin/news' },
    { label: 'درخواست تأیید', value: '۸', icon: <Star size={24} />, color: 'text-yellow-600', bg: 'bg-yellow-50', link: '/admin/verifications' },
  ];
