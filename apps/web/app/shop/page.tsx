...
function pad(n: number) { return String(n).padStart(2,'0').replace(/\d/g, d => '۰۱۲۳۴۵۶۷۸۹'[+d]); }
...
const sampleProducts: Product[] = [
  {id:'1',title:'میز اسنوکر ویراکا مدل M1 Gold',price:85000000,discountPrice:72000000,discountPercent:15,category:'table',condition:'new',city:'تهران',images:[imgs[0]],isVerified:true,isOfficialStore:false,isDailyDeal:false,isSpecialSale:true,seller:{firstName:'علی',lastName:'محمدی',primaryRole:'seller'}},
  {id:'2',title:'چوب بیلیارد Predator 314-3',price:12000000,discountPrice:9600000,discountPercent:20,category:'cue',condition:'like_new',city:'مشهد',images:[imgs[1]],isVerified:true,isOfficialStore:false,isDailyDeal:true,isSpecialSale:true,seller:{firstName:'رضا',lastName:'احمدی',primaryRole:'player'}},
  {id:'3',title:'ست توپ اسنوکر Aramith Tournament',price:4500000,discountPrice:3800000,discountPercent:16,category:'ball',condition:'new',city:'اصفهان',images:[imgs[2]],isVerified:false,isOfficialStore:true,isDailyDeal:true,isSpecialSale:true,seller:{firstName:'بیلیارد',lastName:'پلاس',primaryRole:'admin'}},
  {id:'4',title:'گچ بیلیارد Master Blue Diamond ۱۴۴ عدد',price:850000,discountPrice:680000,discountPercent:20,category:'accessory',condition:'new',city:'تهران',images:[imgs[0]],isVerified:false,isOfficialStore:false,isDailyDeal:true,isSpecialSale:true,seller:{firstName:'محمد',lastName:'حسینی',primaryRole:'seller'}},
  {id:'5',title:'پایه چوب بیلیارد چرمی',price:2200000,discountPrice:1900000,discountPercent:14,category:'accessory',condition:'new',city:'تهران',images:[imgs[1]],isVerified:false,isOfficialStore:false,isDailyDeal:false,isSpecialSale:true,seller:{firstName:'امیر',lastName:'کریمی',primaryRole:'manufacturer'}},
  {id:'6',title:'میز پاکت بیلیارد ۷ فوت',price:35000000,discountPrice:28000000,discountPercent:20,category:'table',condition:'used',city:'شیراز',images:[imgs[2]],isVerified:false,isOfficialStore:false,isDailyDeal:true,isSpecialSale:true,seller:{firstName:'حسین',lastName:'علوی',primaryRole:'user'}},
  {id:'7',title:'کتاب آموزش اسنوکر استیو دیویس',price:350000,discountPrice:280000,discountPercent:20,category:'educational',condition:'new',city:'تهران',images:[imgs[0]],isVerified:false,isOfficialStore:true,isDailyDeal:true,isSpecialSale:true,seller:{firstName:'بیلیارد',lastName:'پلاس',primaryRole:'admin'}},
  {id:'8',title:'تی‌شرت اسپرت بیلیارد XL',price:450000,discountPrice:360000,discountPercent:20,category:'clothing',condition:'new',city:'تهران',images:[imgs[1]],isVerified:false,isOfficialStore:false,isDailyDeal:false,isSpecialSale:true,seller:{firstName:'مجید',lastName:'صادقی',primaryRole:'seller'}},
  {id:'9',title:'میز هی‌بال Artis Vienna Pro',price:22000000,discountPrice:18700000,discountPercent:15,category:'table',condition:'new',city:'تهران',images:[imgs[2]],isVerified:true,isOfficialStore:false,isDailyDeal:true,isSpecialSale:true,seller:{firstName:'کاوه',lastName:'موسوی',primaryRole:'seller'}},
  {id:'10',title:'چوب Mezz EC7 Wavy Joint',price:8500000,discountPrice:7200000,discountPercent:15,category:'cue',condition:'new',city:'مشهد',images:[imgs[0]],isVerified:true,isOfficialStore:false,isDailyDeal:false,isSpecialSale:false,seller:{firstName:'سعید',lastName:'رضایی',primaryRole:'seller'}},
  {id:'11',title:'توپ‌های پاکت Cyclop Galaxy',price:3200000,discountPercent:0,category:'ball',condition:'new',city:'اصفهان',images:[imgs[1]],isVerified:false,isOfficialStore:false,isDailyDeal:false,isSpecialSale:false,seller:{firstName:'نیما',lastName:'کریمی',primaryRole:'user'}},
  {id:'12',title:'دستکش بیلیارد Riley',price:320000,discountPrice:256000,discountPercent:20,category:'accessory',condition:'new',city:'تهران',images:[imgs[2]],isVerified:false,isOfficialStore:false,isDailyDeal:false,isSpecialSale:false,seller:{firstName:'مریم',lastName:'احمدی',primaryRole:'player'}},
];
